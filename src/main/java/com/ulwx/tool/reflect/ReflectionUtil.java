...
public class ReflectionUtil {
    ...
    public static Method[] getClassPublicMethods(Class<?> cls,Class<?> parent) {
        Map<String, Method> uniqueMethods = new HashMap<>();
        Class<?> currentClass = cls;
        while (currentClass != null && currentClass != parent) {
            addUniquePublicMethods(uniqueMethods, currentClass.getDeclaredMethods());
            //获取父类，继续while循环
    ...
    private static void addUniquePublicMethods(Map<String, Method> uniqueMethods, Method[] methods) {
    ...
    public static Object invokeSeflMethod(Object object, String methodName,
                                Class<?>[] argTypes, Object[] argValues) throws
            Exception {
        // 获取obj类的字节文件对象
        Class c=null;
    ...
    public static Object invokeSeflMethod(Object object, String methodName) throws
            Exception {
        Class c=null;
        if(object instanceof Class){
            c=(Class)object;
