...
public class ArrayUtils {
	...
	public static <T> Set<T> Intersection(T[] src1, T[] src2) {
		...
		if(src1==null) {
			if(src2!=null) {
				Collections.addAll(list, src2);
				return list;
			}
		}
		if(src2==null){
			if(src1!=null) {
				Collections.addAll(list, src1);
				return list;
			}
		}
	...
	public static void main(String[] args) {
		...
		// System.out.println(ArrayUtils.toString(des2));
		// byte[] des2=addLenToByteArrayHead(des);
		// des2=append(des2,addLenToByteArrayHead(des));
		// reverse(des);
		// System.out.println(ArrayUtils.toString(des, " "));
		// System.out.println(contains(des, 97));
		...
		// //System.out.println(ArrayUtils.toString(ojs, ","));
		// DateTime[] ds=(DateTime[])ArrayUtils.toArray(list);
		// System.out.println(ArrayUtils.toString(ArrayUtils.toArray(list)));
		// //
		// List<Integer> list = new ArrayList();
		// list.add(1);
		// list.add(2);
		// list.add(-333);
		// System.out.println(toString(IntegerListToIntegerArray(list)));

		// System.out.println(ObjectUtils.nullSafeToString((long[])null));

		// System.out.println(toString(IntegerListToIntegerArray(list)));
		// Object[] bss=getBytesFromLenByteArray(des2);
		// byte[] bsss=(byte[])bss[1];
		// System.out.println(HexUtils.format(bsss));

		// String[] s=new String[]{"123","345","566"};
		// System.out.println(StringArrayToLongArray(s)[1]);
		// String[][] as = new String[5][];
		// String[] bs = new String[] { "123", "456", "789" };
		// ArrayUtils.fill(as, bs);
		// // System.out.println(StringUtils.printStringArray(as));
		// for (int i = 0; i < as.length; i++) {
		// System.out.println(StringUtils.printStringArray(as[i]));
		// }

		Integer[] is = new Integer[] { 1, 11, 3, 4, 6, 3, 4, 5 };
		...
		// System.out.println(ArrayUtils.toString(obs));
		//
		//
		// Integer[] iis = ArrayUtils.map(
		// new Integer[] { 1, 11, 3, 4, 6, 3, 4, 5 },
		// new Callback<Integer, Integer>() {
		// public Integer call(Integer obj) {
		// return obj + 2;
		// }
		// });
		// System.out.println(ArrayUtils.toString(iis));
		//
		// System.out.println(int.class.isPrimitive());
		// System.out.println(ArrayUtils.indexOf(is, 0));
		// List<Integer> channelList=new ArrayList<Integer>();
		// channelList.add(10);
		// channelList.add(1);
		// channelList.add(11);
		// Collections.sort(channelList, Collections
		// .reverseOrder(new Comparator<Integer>() {
		//
		...
		// }));
		//
		// System.out.println(CollectionUtils.toString(channelList));
//		String ss = "66666@12345@";
//		String[] strs = StringUtils.split(ss, "@");
//		System.out.println(ArrayUtils.toString(strs));
//		System.out.println(String.class.equals(int.class));
//		System.out.println(String.class.equals(String.class));
		Long[] a1=new Long[] {2l,34l,1l};
		Integer[] a2=new Integer[] {2,34,1};
